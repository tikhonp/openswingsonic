...
type AlbumID3WithSongs struct {
	...
	Artists             []ArtistFromAlbum `json:"artists"`
	DisplayArtist       string            `json:"displayArtist"`
	ReleaseTypes        []string          `json:"releaseTypes"`
	Moods               []string          `json:"moods"`
	SortName            string            `json:"sortName"`
	OriginalReleaseDate ReleaseDate       `json:"originalReleaseDate"`
...
type Song struct {
	...
	DisplayArtist      string            `json:"displayArtist"`
	AlbumArtists       []ArtistFromAlbum `json:"albumArtists"`
...
type Contributor struct {
	...
	Artist  ArtistFromAlbum `json:"artist"`
